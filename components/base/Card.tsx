...
export const Card = ({ label, text, slabel, imagepath }: CardProps) => {
  return (
    <div className="w-[22.375rem] h-[28.438rem] border-purple shadow-card rounded-[9px]">
      ...
      <label className="text-white flex mt-11 ml-10 text-2xl tracking-[0.15em]">{label}</label>
      <p className="text-white flex ml-12 mr-10 text-sm font-light tracking-widest leading-8">{text}</p>
    </div>
  );
};
