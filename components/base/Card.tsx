...
export const Card = ({ cardName, text, cardTag, imagePath }: CardProps) => {
  return (
    <div className="w-[18rem] h-[25rem] lg:w-auto lg:max-w-[22rem] lg:min-w-[352px] lg:h-[28rem] border-purple shadow-card rounded-lg">
      ...
      <p className="text-white flex text-sm mx-10 pt-1 font-light tracking-widest leading-8">
        {text}
      </p>
    </div>
  );
